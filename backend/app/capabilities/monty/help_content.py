...
SANDBOX_GUIDANCE = (
    ...
    "operations and Plotly visualizations. Use `help()` to discover collections, "
    ...
    "Imports are intentionally limited; local pydantic-monty supports `math`, "
    "`json`, and `re` for simple scalar/string work, while scientific and "
